        ...
        <div class="col-md-4 col-md-offset-4" style="max-width:800px;min-width:400px">
            <div class="login-panel panel panel-default">
                <div class="panel-header">
                    <a href="index.php"><img class="center-block" src="../resources/mm_logo.png" style="min-width:125px;max-width:250px;display:block;"></a></div>
                    ...
                    <form role="form" action="../resources/profileedit.php" method="POST" name="profileform">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <input required pattern="[A-Za-z]{1,}" class="form-control" name="firstname" type="text" title="Alphabetic characters only" value="<?php echo $_SESSION['firstname']; unset($_SESSION['firstname']);?>">
                            </div>
                            <!-- Input for last name -->
                            <h5>Last Name:</h5>
